...
public class Reception extends JFrame {
    ...
    public Reception(){
        ...
        JButton btnNewButton_8 = new JButton("add driver");
        btnNewButton_8.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                try {
                   AddDrivers fd =new AddDrivers();
                   fd.setVisible(true);
                    setVisible(false);
        ...
        JButton btnNewButton_9 = new JButton("add emploee");
        ...
        btnNewButton_9.setBounds(300, 510, 200, 30);
        btnNewButton_9.setBackground(Color.BLACK);
        btnNewButton_9.setForeground(Color.WHITE);

        contentPane.add(btnNewButton_9);
        JButton btnNewButton_10 = new JButton("add room");
        btnNewButton_10.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                try {
                    AddRoom fd =new AddRoom();
                    fd.setVisible(true);
                    setVisible(false);
        ...
        btnNewButton_10.setBounds(300, 470, 200, 30);
